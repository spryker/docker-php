...
* Based on official PHP images
  * `Alpine 3.18 (Deprecation from 09 May 2025)`
  * `Alpine 3.19`
  * `Alpine 3.20`
  * `Alpine 3.21`
  * `Debian "bullseye"`
